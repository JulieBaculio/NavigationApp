...
export default function Signup(props) {
  return (
    <View>
        ...
        <TextInput label="Confirm Password" secureTextEntry right={<TextInput.Icon icon="eye" />} style={{marginBottom: 5, marginTop: 5, height: 50, width: 250}}/>
       
        <Button 
          mode="contained" 
          icon="account-plus" 
          style={{ width: 250}}  
          onPress={()=>props.navigation.navigate("Login")}>Register</Button>
    </View> 
  )
}